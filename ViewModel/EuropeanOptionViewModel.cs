...
namespace Financer.ViewModel
{
    ...
    /// </para>
    /// </summary>
    public class EuropeanOptionViewModel : ViewModelBase
    {
        /// <summary>
        /// Initializes a new instance of the EuropeanOptionViewModel class.
        /// </summary>
        public EuropeanOptionViewModel()
        {
            _spotPrice = 100;
            _interestRate = 0.05;
            _volatility = 0.3;
        ...
        private void DoCalculation()
        {
            ...
            {
                var prob = new EuropeanOptionProb(
                        _spotPrice,
                        _volatility,
                        _interestRate,
                        _maturity,
